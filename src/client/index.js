...
const HomePage = ()=>{
    ...
    <!-- SKILL -->
    <div class="bg-[#232529] w-full" style="border-top: 1px solid #2b2d33">
        <div class="max-w-6xl m-auto pt-[50px] pb-[200px]" id="skill">
            <div class="">
                ...
                <div class="grid grid-cols-4 gap-4">
                    <div class="flex justify-center">
                        <div class="">
                            <div class="bg-[#2b2d33] w-[150px] p-10 rounded-[50%] hover:scale-110"
